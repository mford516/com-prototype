System.register(['angular2/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            GroupClassComponent = (function () {
                function GroupClassComponent(elementRef) {
                    var _this = this;
                    this.classSelectLabel = 'Select...';
                    setTimeout(function () {
                ...
                GroupClassComponent.prototype.getClasss = function () {
                    this.classes = [
                        { 'id': '1', 'name': 'Staff' },
                        { 'id': '2', 'name': 'Parents' },
                        { 'id': '3', 'name': 'Students' },
                ...
                GroupClassComponent.prototype.onSelect = function () {
                    this.classSelectLabel = this._menuRef.selectedItems[0].innerText;
                };
                GroupClassComponent.prototype.ngOnInit = function () {
                    this.getClasss();
                };
                GroupClassComponent = __decorate([
                    core_1.Component({
                ...
                return GroupClassComponent;
            }());
            exports_1("GroupClassComponent", GroupClassComponent);
        }
    }
});
//# sourceMappingURL=group-classes.component.js.map