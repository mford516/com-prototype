System.register(['./mock-accounts', 'angular2/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SMSAccountService = (function () {
                function SMSAccountService() {
                }
                SMSAccountService.prototype.getAccounts = function (groupID) {
                    if (groupID === "1")
                ...
                SMSAccountService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [])
                ], SMSAccountService);
                return SMSAccountService;
            }());
            exports_1("SMSAccountService", SMSAccountService);
        }
    }
});
//# sourceMappingURL=sms-recipient-account.service.js.map